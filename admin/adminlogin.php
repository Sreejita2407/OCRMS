   ...
   <div class="container tm-container">
            ...
            <div class="row navbar-row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 navbar-container">
                    ...
                    <a href="javascript:void(0)" class="navbar-brand" id="go-to-top"> My College </a>
            ...
            <div class="tm-page-content">                
                ...
                <section id="tm-section-1" class="row tm-section">
                    ...
                    <div class="tm-white-curve-left col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header blue-text">Our Mission</h2>
                            <p>
                        
										
										<strong>To Develop </strong> and serve high quality academic  and technical skill programs that would ensure employability & and productivity of young men and women through propervalues abd principles as a means to achieve sucess with excellence for a better quality of life.
                            </p>
                    ...
                    <div class="tm-home-right col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-6">
                        <h2 class="tm-section-header">Our Vission</h2>
                        <p class="thin-font">
						
                        <strong>A center of excellence in academics and technical skills program in pursuing dynamic opportunities parallel to global standards, uplifting the socio-economic growth of the country</strong>
						</p>
                    </div>
                ...
                <section id="tm-section-3" class="row tm-section">
                    <div class="tm-white-curve-left col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header gray-text">About My College</h2>
                            <p class="thin-font">Lorem ipsum.</p>    
                        </div>
                ...
                <section id="tm-section-4" class="row tm-section">
                    ...
                    <div class="tm-white-curve-right col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            ...
                            <p>Admissions & General Info: </br>
Call Center:000000000 </br>
Email: test@test.com </br>
Office hours: Mon-Sat, 8am-6pm (GMT+8) </br>
